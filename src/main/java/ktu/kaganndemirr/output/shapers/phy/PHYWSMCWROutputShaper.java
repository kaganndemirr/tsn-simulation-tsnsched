...
import ktu.kaganndemirr.output.holders.phy.PHYWSMCWRHolder;
...
public class PHYWSMCWROutputShaper {
    private static final Logger logger = LoggerFactory.getLogger(PHYWSMCWROutputShaper.class.getSimpleName());
    ...
    public PHYWSMCWROutputShaper(PHYWSMCWRHolder phycWSMCWRHolder) {
        topologyOutputLocation = Paths.get("outputs", phycWSMCWRHolder.getSolver(), phycWSMCWRHolder.getMethod(), phycWSMCWRHolder.getAlgorithm(), phycWSMCWRHolder.getRandomizationCWR(), phycWSMCWRHolder.getWSMNormalization(), phycWSMCWRHolder.getMCDMObjective(), String.valueOf(phycWSMCWRHolder.getK()), phycWSMCWRHolder.getTopologyName() + "_" + phycWSMCWRHolder.getApplicationName()).toString();

        new File(topologyOutputLocation).mkdirs();

        mainOutputLocation = Paths.get("outputs", phycWSMCWRHolder.getSolver(), phycWSMCWRHolder.getMethod(), phycWSMCWRHolder.getAlgorithm(), phycWSMCWRHolder.getRandomizationCWR(), phycWSMCWRHolder.getWSMNormalization(), phycWSMCWRHolder.getMCDMObjective(), String.valueOf(phycWSMCWRHolder.getK())).toString();
