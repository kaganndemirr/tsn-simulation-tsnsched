...
import ktu.kaganndemirr.output.holders.phy.PHYHolder;
...
public class PHYOutputShaper {
    private static final Logger logger = LoggerFactory.getLogger(PHYOutputShaper.class.getSimpleName());
    ...
    public PHYOutputShaper(PHYHolder phyHolder) {
        topologyOutputLocation = Paths.get("outputs", phyHolder.getSolver(), phyHolder.getAlgorithm(), phyHolder.getMethod(), String.valueOf(phyHolder.getK()), phyHolder.getTopologyName() + "_" + phyHolder.getApplicationName()).toString();

        new File(topologyOutputLocation).mkdirs();

        mainOutputLocation = Paths.get("outputs", phyHolder.getSolver(), phyHolder.getAlgorithm(), phyHolder.getMethod(), String.valueOf(phyHolder.getK())).toString();
