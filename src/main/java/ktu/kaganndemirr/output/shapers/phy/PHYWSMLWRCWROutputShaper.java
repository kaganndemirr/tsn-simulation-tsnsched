...
import ktu.kaganndemirr.output.holders.phy.PHYWSMLWRCWRHolder;
...
public class PHYWSMLWRCWROutputShaper {
    private static final Logger logger = LoggerFactory.getLogger(PHYWSMLWRCWROutputShaper.class.getSimpleName());
    ...
    public PHYWSMLWRCWROutputShaper(PHYWSMLWRCWRHolder phyWSMLWRCWRHolder) {
        topologyOutputLocation = Paths.get("outputs", phyWSMLWRCWRHolder.getSolver(), phyWSMLWRCWRHolder.getAlgorithm(), phyWSMLWRCWRHolder.getRandomizationLWR(), phyWSMLWRCWRHolder.getRandomizationCWR(), phyWSMLWRCWRHolder.getWSMNormalization(), phyWSMLWRCWRHolder.getMCDMObjective(), phyWSMLWRCWRHolder.getMethod(), String.valueOf(phyWSMLWRCWRHolder.getK()), phyWSMLWRCWRHolder.getTopologyName() + "_" + phyWSMLWRCWRHolder.getTopologyName() + "_" + phyWSMLWRCWRHolder.getApplicationName()).toString();

        new File(topologyOutputLocation).mkdirs();

        mainOutputLocation = Paths.get("outputs", phyWSMLWRCWRHolder.getSolver(), phyWSMLWRCWRHolder.getAlgorithm(), phyWSMLWRCWRHolder.getRandomizationLWR(), phyWSMLWRCWRHolder.getRandomizationCWR(), phyWSMLWRCWRHolder.getWSMNormalization(), phyWSMLWRCWRHolder.getMCDMObjective(), phyWSMLWRCWRHolder.getMethod(), String.valueOf(phyWSMLWRCWRHolder.getK())).toString();
