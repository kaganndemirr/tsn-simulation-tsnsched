...
import ktu.kaganndemirr.output.holders.phy.PHYWSMLWRHolder;
...
public class PHYWSMLWROutputShaper {
    private static final Logger logger = LoggerFactory.getLogger(PHYWSMLWROutputShaper.class.getSimpleName());
