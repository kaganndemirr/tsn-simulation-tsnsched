...
import ktu.kaganndemirr.output.holders.phy.PHYWPMv1Holder;
import ktu.kaganndemirr.output.holders.phy.PHYWPMv2Holder;
...
public class PHYWPMv1OutputShaper {
    ...
    public PHYWPMv1OutputShaper(PHYWPMv1Holder phyWPMv1Holder) {
        topologyOutputLocation = Paths.get("outputs", phyWPMv1Holder.getSolver(), phyWPMv1Holder.getMethod(), phyWPMv1Holder.getAlgorithm(), phyWPMv1Holder.getMCDMObjective(), String.valueOf(phyWPMv1Holder.getWAVB()), String.valueOf(phyWPMv1Holder.getWTT()), String.valueOf(phyWPMv1Holder.getWLength()), String.valueOf(phyWPMv1Holder.getWUtil()), String.valueOf(phyWPMv1Holder.getK()), phyWPMv1Holder.getWPMVersion(), phyWPMv1Holder.getTopologyName() + "_" + phyWPMv1Holder.getApplicationName()).toString();

        new File(topologyOutputLocation).mkdirs();

        mainOutputLocation = Paths.get("outputs", phyWPMv1Holder.getSolver(), phyWPMv1Holder.getMethod(), phyWPMv1Holder.getAlgorithm(), phyWPMv1Holder.getMCDMObjective(), String.valueOf(phyWPMv1Holder.getWAVB()), String.valueOf(phyWPMv1Holder.getWTT()), String.valueOf(phyWPMv1Holder.getWLength()), String.valueOf(phyWPMv1Holder.getWUtil()), String.valueOf(phyWPMv1Holder.getK()), phyWPMv1Holder.getWPMVersion()).toString();
