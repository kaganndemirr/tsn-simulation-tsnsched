...
import ktu.kaganndemirr.output.holders.phy.PHYWPMCWRv2Holder;
...
public class PHYWPMCWRv2OutputShaper {
    private static final Logger logger = LoggerFactory.getLogger(PHYWPMCWRv2OutputShaper.class.getSimpleName());
