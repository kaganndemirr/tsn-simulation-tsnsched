...
import ktu.kaganndemirr.output.holders.phy.PHYWSMHolder;
...
public class PHYWSMOutputShaper {
    private static final Logger logger = LoggerFactory.getLogger(PHYWSMOutputShaper.class.getSimpleName());
