...
import ktu.kaganndemirr.output.holders.phy.PHYShortestPathHolder;
...
public class ShortestPathOutputShaper {
    private static final Logger logger = LoggerFactory.getLogger(ShortestPathOutputShaper.class.getSimpleName());
    ...
    public ShortestPathOutputShaper(PHYShortestPathHolder phyShortestPathHolder) {
        topologyOutputLocation = Paths.get("outputs", phyShortestPathHolder.getSolver(), phyShortestPathHolder.getMethod(), phyShortestPathHolder.getAlgorithm(), phyShortestPathHolder.getTopologyName() + "_" + phyShortestPathHolder.getApplicationName()).toString();

        new File(topologyOutputLocation).mkdirs();

        mainOutputLocation = Paths.get("outputs", phyShortestPathHolder.getSolver(), phyShortestPathHolder.getMethod(), phyShortestPathHolder.getAlgorithm()).toString();
