...
public class SRTApplication extends Application {
    public SRTApplication(String name, int pcp, String type, double deadline, double frameSizeByte, int numberOfFrames, EndSystem source, EndSystem target, double CMI, double messageSizeMbps, ExplicitPath explicitPath) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass()) {
            ...
            SRTApplication objApp = (SRTApplication) obj;
