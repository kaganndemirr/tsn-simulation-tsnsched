...
public class LaursenInitialSolutionDST extends Solver {
    ...
    public Solution solveH(final Graph<Node, GCLEdge> physicalTopology, final List<Application> applications, final Evaluator evaluator) {
        ...
        solution = LaursenInitialSolutionMethods.constructInitialSolutionDST(avbUnicastCandidates, ttUnicasts, k, evaluator);
