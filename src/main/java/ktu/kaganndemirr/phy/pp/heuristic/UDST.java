...
public class UDST extends Solver {
    private static final Logger logger = LoggerFactory.getLogger(UDST.class.getSimpleName());
    ...
    public Solution solveHU(final Graph<Node, GCLEdge> physicalTopology, final List<Application> applications, final Evaluator evaluator, int rate) {
        ...
        solution = USpecificMethods.constructSolutionDST(avbUnicastCandidates, ttUnicasts, rate);
