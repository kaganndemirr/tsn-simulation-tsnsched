...
public class LaursenInitialSolutionD extends Solver {
    ...
    public Solution solveH(final Graph<Node, GCLEdge> physicalTopology, final List<Application> applications, final Evaluator evaluator) {
        ...
        solution = LaursenInitialSolutionMethods.constructInitialSolutionD(avbUnicastCandidates, ttUnicasts, k, evaluator);
